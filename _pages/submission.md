...
Please make sure to create an account early in order to avoid any submission issues close to the deadline (20<sup>th</sup> of December 2026, 23:59 CET).

<h4>Requirements</h4>

Your manuscript submitted to SSVM should describe original and unpublished work. Simultaneous submission to other conferences with proceedings or submission of previously published material is <b>not</b> acceptable.

The maximum length of manuscripts is <b>12 pages</b> including bibliography.

As our reviewing process is double blinded, the manuscripts must be <b>anonymous</b>. Authors’ names should not appear in the submitted files. When citing your own work, please do so in a neutral way (use "In [2], the authors show..." instead of "In [2], we show...").

Note that manuscripts that do not follow these requirements will be rejected without review.
